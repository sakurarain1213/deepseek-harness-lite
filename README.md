...
All five repository-owned packages are `bundled`: install, build, and activation evidence is pinned to source commit `2e1c0f3c3aca5148895b9f4ef2a2ab859105b5fd`. External catalog entries use separate `verified`, `listed`, or `blocked` states. See [plugin authoring and catalog submission](docs/plugin-authoring.md).
