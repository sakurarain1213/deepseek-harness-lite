...
All five repository-owned packages are `bundled`: install, build, and activation evidence is pinned to source commit `55f028439d7210afac8bfff7dd3f2ff6df393fc8`. External catalog entries use separate `verified`, `listed`, or `blocked` states. See [plugin authoring and catalog submission](docs/plugin-authoring.md).
