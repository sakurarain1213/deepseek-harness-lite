...
五个仓库自有包现均为 `bundled`：安装、构建与激活证据绑定到源码提交 `c0b1c9ac8d8be2cb4332fad3ba7ee6ca384dbae0`。外部 catalog 条目根据证据分别标为 `verified`、`listed` 或 `blocked`。提交流程见 [插件开发文档](docs/plugin-authoring.md)。
