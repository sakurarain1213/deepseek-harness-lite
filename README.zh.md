...
五个仓库自有包现均为 `bundled`：安装、构建与激活证据绑定到源码提交 `55f028439d7210afac8bfff7dd3f2ff6df393fc8`。外部 catalog 条目根据证据分别标为 `verified`、`listed` 或 `blocked`。提交流程见 [插件开发文档](docs/plugin-authoring.md)。
